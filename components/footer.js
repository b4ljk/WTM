import { Box, Flex, HStack, Link, Stack, Text, VStack, Container, Icon } from "@chakra-ui/react";
	...
	return (
		<Box bg="gray.50" py="4">
			<Container maxW="container.lg" bg="transparent">
				<Box _dark={{ bg: "gray.600" }}>
					<Stack direction={{ base: "column", lg: "row" }} w="full" justify="space-between" py="7">
						<Box
							display={"flex"}
